...
public class Controller2 : MonoBehaviour
{
    ...
    private void Move()
    {
        ...
        //    transform.rotation = Quaternion.Slerp(transform.rotation, attackRot, rSpeed * Time.deltaTime * 0.1f);
